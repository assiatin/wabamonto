...
<!-- BANNER SECTION -->
<section class="clearfix homeBanner" style="background-image: url(<?php echo base_url();?>assets/wabamonto/img/banner/banner1.jpg);">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<div class="banerInfo">
					<h1>Wabamonto</h1>
					<p>Plate-forme de covoiturage au Bénin</p>
                    ...
                    <div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="findItem" placeholder="Ville depart">
                    ...
                    <div class="form-group">
							<div class="input-group">
								<div class="input-group-addon">Arrivée</div>
								<input type="text" class="form-control" id="findItem" placeholder="Ville Arrivée">
								<div class="input-group-addon addon-right"></div>
							</div>
                    </div>
                     </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="nearLocation" placeholder="Heure départ">
...
<section class="clearfix worksArea">
	<div class="container">
		<div class="page-header text-center">
			<h2>Wabamonto <small>Plate forme de covoiturage </small></h2>
		</div>
		<div class="row">
			<div class="col-sm-3 col-xs-12">
				<div class="thumbnail text-center worksContent">
					<img src="<?php echo base_url();?>assets/wabamonto/img/works/works-1.png" alt="Image works">
					<div class="caption">
						<a href="how-it-works.html"><h3>NE PARTEZ PLUS TOUT SEUL</h3></a>
						<p>Vous avez un voyage en vue, publiez votre trajet sur wabamonto.</p>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-12">
				<div class="thumbnail text-center worksContent">
					<img src="<?php echo base_url();?>assets/wabamonto/img/works/works-2.png" alt="Image works">
					<div class="caption">
						<a href="how-it-works.html"><h3>VOYAGER EN TOUTE CONFIANCE</h3></a>
						<p>Des profils et des voitures 100% vérifié par nos equipes.<br/>&nbsp;</p>
					</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-12">
				<div class="thumbnail text-center worksContent">
					<img src="<?php echo base_url();?>assets/wabamonto/img/works/works-3.png" alt="Image works">
					<div class="caption">
						<a href="how-it-works.html"><h3>PARTAGEZ LE COÛT DE LA COURSE</h3></a>
						<p>Vous choisissez le coût du trajet et les autres vous choisissent</p>
					</div>
				</div>
			</div>
            <div class="col-sm-3 col-xs-12">
				<div class="thumbnail text-center worksContent">
					<img src="<?php echo base_url();?>assets/wabamonto/img/works/works-1.png" alt="Image works">
					<div class="caption">
						<a href="how-it-works.html"><h3>FACILE À UTILISER<br/>&nbsp;</h3></a>
						<p>Cliquez ici pour ajouter votre propre texte. Relatez<br/>&nbsp;</p>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12">
				<div class="btnArea text-center"><a href="#" class="btn btn-primary">Savoir plus <i class="fa fa-play-circle" aria-hidden="true"></i></a></div>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-sm-3 col-xs-12">
				<div class="text-center countItem">
					...
					<div class="counterInfo bg-color-1">Visites</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-12">
				<div class="text-center countItem">
					<div class="counter">120</div>
					<div class="counterInfo bg-color-2">Profiles verifier</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-12">
				<div class="text-center countItem">
					<div class="counter">180</div>
					<div class="counterInfo bg-color-3">Trajet publies</div>
				</div>
			</div>
			<div class="col-sm-3 col-xs-12">
				<div class="text-center countItem">
					<div class="counter">220</div>
					<div class="counterInfo bg-color-4">Réservation</div>
				</div>
			</div>
		</div>
		<!--<div class="row">
