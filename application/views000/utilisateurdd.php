                ...
                <div class="content">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                       <input type="text" value="<?php echo $login;?>" name="login" class="form-control"  required="required" placeholder="Login de l'utilisateur">

                      </div>
                      
                      <label for="inputEmail3" class="col-sm-2 control-label">Titre</label>
                      <div class="col-sm-4">
                        <input type="text" value="<?php echo $titre;?>" name="titre" class="form-control"  required="required" placeholder="Titre de l'utilisateur">
                    ...
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Profil dddd </label>
                      <div class="col-sm-4">
...
<div class="row">
						...
						<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>Liste des Competences</b></h4>
					...
					foreach ($utilisateur as $liste) 
					{
						...
						echo "<tr>
							  <td>".($i)."</td>
							 <td>".$liste->Login."</td>
							  <td>".$liste->Nom_Utilisateur ."  ".$liste->Prenom_Utilisateur 	."</td>
							  <td>".$liste->profil."</td>
							   <td align='right'  ><a href='".  site_url('admin/utilisateur/'.$liste->Id) ."' class='fa fa-pencil label label-info'> mod</a>&nbsp;";
							   if ($liste->Actif!=1)
							 	 echo" <a href='".  site_url('admin/user_activer/'.$liste->Id.'/1') ."' onclick='go_activer(".$liste->Id.",0)' id='".$liste->Id."' class='fa fa-check label label-success '> activer &nbsp;&nbsp;&nbsp;&nbsp;</a>";
							  else
							  	 echo" <a href='".  site_url('admin/user_activer/'.$liste->Id.'/0') ."' onclick='go_activer(".$liste->Id.",1)' id='".$liste->Id."' class='fa fa-check label label-danger '> desactiver</a>";
